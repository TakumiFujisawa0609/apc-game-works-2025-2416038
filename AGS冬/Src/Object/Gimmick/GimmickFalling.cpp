...
void GimmickFalling::DrawWave1(void)
{
    if (!isActive_) return;
...
void GimmickFalling::DrawWave2(void)
{
    if (!isActive_) return;
...
void GimmickFalling::DrawWave3(void)
{
    if (!isActive_) return;
